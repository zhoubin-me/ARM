...
class VoxelGrid(nn.Module):
    def __init__(
        ...
        self._voxel_feature_size = feature_size
        ...
        self._total_dims_list = torch.cat(
            [
                ...
                max_dims,
                torch.tensor([feature_size], device=device),
            ],
            -1,
        ).tolist()
    ...
    def coords_to_bounding_voxel_grid(
        ...
        # BS x NC x 3
        assert coord_features is not None
        voxel_values = coord_features
        ...
        voxel_values_pruned_flat = voxel_values
