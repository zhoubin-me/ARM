...
class Perceiver(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.decoder_cross_attn = PreNorm(
            input_channels,
            Attention(
                input_channels, latent_dim, heads=cross_heads, dim_head=cross_dim_head
            ),
    ...
    def forward(
        ...
        self.decoder_cross_attn(queries, context=x)
        output = queries.reshape(*queries_shape)

        return self.decoder_ff(output)